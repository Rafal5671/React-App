    ...
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.section}>
        ...
        <List.Item
          ...
          titleStyle={{ color: colors.text }}
          left={() => <List.Icon icon="file-document-outline" color={colors.icon} />}
          right={() => <List.Icon icon="chevron-right" color={colors.icon} />}
          onPress={() => {}}
        />
        <List.Item
        ...
        <List.Item
          ...
          titleStyle={{ color: colors.text }}
          left={() => <List.Icon icon="package-variant-closed" color={colors.icon} />}
          right={() => <List.Icon icon="chevron-right" color={colors.icon} />}
          onPress={() => {}}
        />
      </View>
      ...
      <View style={styles.section}>
        ...
        <List.Item
          ...
          titleStyle={{ color: colors.text }}
          left={() => <List.Icon icon="help-circle-outline" color={colors.icon} />}
          right={() => <List.Icon icon="chevron-right" color={colors.icon} />}
          onPress={() => {}}
        />
        <List.Item
          title="O nas"
          titleStyle={{ color: colors.text }}
          left={() => <List.Icon icon="information-outline" color={colors.icon} />}
          right={() => <List.Icon icon="chevron-right" color={colors.icon} />}
          onPress={() => {}}
        />
      </View>
      ...
      <TouchableOpacity
  style={styles.logoutButton} // This triggers the logout function
>
...
const styles = StyleSheet.create({
  ...
  logoutButton: {
    backgroundColor: '#FF5A5F', // A strong red color for emphasis
    paddingVertical: 12,
    paddingHorizontal: 24,
    borderRadius: 8,
    alignItems: 'center',
    marginTop: 20,
    width: '100%', // Adjust to fit nicely on screen
  },
  logoutText: {
